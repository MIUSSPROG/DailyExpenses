...
interface ItemToBuyDao {
    ...
    suspend fun getAllItemsInRange(userId: Int, fromDate: Long, toDate: Long): List<HistogramData>
    ...
    suspend fun getAllItemsByCategory(userId: Int, fromDate: Long, toDate: Long): List<DiagramData>
